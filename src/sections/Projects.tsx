import DevportfolioAi from "@/public/DevportfolioAi.png";
...
const portfolioProjects = [
  {
    ...
    results: [
      { title: "Purchase anything you want" },
      { title: "Increased user engagement by 60%" },
      { title: "Enhanced platform performance" },
    ],
    link: "https://github.com/dharmender0007/Amazon-Clone",
    image: AmazonClone,
  },
  {
  ...
  },
  {
    ...
    title: "Order Food ",
    results: [
      { title: "Implemented Shameless Experience" },
      { title: "Enhanced loading speed by 40%" },
      { title: "Seamless performance on all devices" },
    ],
    link: "https://github.com/dharmender0007/tiffin-service",
    image: TiffineService,
  },
